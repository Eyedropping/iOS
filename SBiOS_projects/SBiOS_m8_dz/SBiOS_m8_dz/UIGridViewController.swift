...
//    @IBOutlet weak var UIGrid: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        let imageName = "13597685_1224449080939233_1667780838_n"
        let image = UIImage(named: imageName)
        
        var images: [UIImageView?]
        let imageV = UIImageView(frame: CGRect(x: 50, y: 100, width: self.view.frame.width / 2 - , height: 150))
        
        func createSubView() {
            let 1 = UIImageView(frame: CGRect
            let 2 = UIImageView()
        }
